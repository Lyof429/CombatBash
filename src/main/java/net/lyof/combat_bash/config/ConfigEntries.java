...
public class ConfigEntries {
    public static void reload() {
        ...
        damage = new ConfigEntry<>("combat_bash.damage", 4f).get();
        ...
        extraExhaustion = new ConfigEntry<>("combat_bash.extra_exhaustion", 0.03f).get();
    ...
    public static float extraExhaustion;
